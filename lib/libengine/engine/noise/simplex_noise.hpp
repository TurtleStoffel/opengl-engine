...
namespace Engine {
    ...
    class SimplexNoise {
      public:
         ...
         * @param[in] amplitude    Amplitude ("height") of the first octave of noise (default
         * to 1.0)
         * @param[in] lacunarity   Lacunarity specifies the frequency multiplier between successive
         * octaves (default to 2.0).
         * @param[in] persistence  Persistence is the loss of amplitude between successive octaves
